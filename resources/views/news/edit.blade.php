                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12" style="margin-top:20px;">
                                    <textarea class="ckeditor-classic" name="content"> {{ $news->content }}</textarea>
                                            ...
                                            <div id="accor_fill22" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-md-12" style="margin-top:15px">
                                                        ...
                                                        <textarea id="editor1" name="content_eng">{{ $news->content_eng }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($news->image)
                                        <img style="margin-top:20px;"
                                            src="{{ asset('upload/image/' . $news->image) }}" alt="image"
                                            width="100%">
                                    @endif
