                            ...
                            <form class="row g-3" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="description" name="description"
                                        value="{{ old('description', $capability->description) }}">{{ $capability->description }} </textarea>
                                    @error('description')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control" id="image" name="image"
                                        value="{{ old('image', $capability->image) }}">
                                    @error('image')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <br>
                                    <img src="{{ asset('upload/image/' . $capability->image) }}" alt=""
                                        style="height: 200px;">
                                </div>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea class="form-control" id="description_eng" name="description_eng"
                                                            value="{{ old('description_eng', $capability->description_eng) }}">{{ $capability->description_eng }}
                                                        </textarea>
