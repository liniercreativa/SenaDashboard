                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST"
                                action="{{ url('') }}/home/slider_update/{{ $slider->id }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="sub_text" name="sub_text"
                                        value="{{ old('sub_text', $slider->sub_text) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="primary_text" name="primary_text"
                                        value="{{ old('primary_text', $slider->primary_text) }}">
                                    @error('primary_text')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="button_link" name="button_link"
                                        value="{{ old('button_link', $slider->button_link) }}" placeholder="#">
                                    @error('button_link')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    {{-- <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="sub_text_eng"
                                                            name="sub_text_eng"
                                                            value="{{ old('sub_text_eng', $slider->sub_text_eng) }}">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="primary_text_eng"
                                                            ...
                                                            value="{{ old('primary_text_eng', $slider->primary_text_eng) }}">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="button_text_eng"
                                                            ...
                                                            value="{{ old('button_text_eng', $slider->button_text_eng) }}">
