                            ...
                            <form class="row g-3" method="POST" action="{{ route('header.news_update') }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($header->header_news_image)
                                        <img src="{{ asset('upload/image/' . $header->header_news_image) }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="header_news_text"
                                        ...
                                        value="{{ old('header_news_text', $header->header_news_text) }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="header_news_text_eng"
                                        name="header_news_text_eng"
                                        value="{{ old('header_news_text_eng', $header->header_news_text_eng) }}">
                                    @error('header_news_text_eng')
                                        <div class="error-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
