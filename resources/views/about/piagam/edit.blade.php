                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST"
                                action="{{ url('') }}/about/piagam_update/{{ $piagamdetail->id }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <input type="hidden" name="id" value="{{ $piagamdetail->id }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (!empty($piagamdetail->image))
                                        <img src="{{ asset('upload/image/' . $piagamdetail->image) }}" alt="image"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" name="kategori" id="kategori">
                                        ...
                                        <option value="award" @if ($piagamdetail->kategori == 'award') selected @endif>Award
                                        </option>
                                        <option value="sertifikat" @if ($piagamdetail->kategori == 'sertifikat') selected @endif>
                                            Sertifikat</option>
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ old('title', $piagamdetail->title) }}">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                                href="{{ url('') }}/about/piagam_edit/{{ $val->id }}"><i
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item remove-item-btn"
                                                                ...
                                                                href="{{ url('') }}/about/piagam_destroy/{{ $val->id }}">
                                                                <i
