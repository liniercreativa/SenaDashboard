                            ...
                            <form class="row g-3" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (!empty($akhlakdetail->image1))
                                        <img src="{{ asset('upload/image/' . $akhlakdetail->image1) }}" alt="image1"
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (!empty($akhlakdetail->image2))
                                        <img src="{{ asset('upload/image/' . $akhlakdetail->image2) }}" alt="image1"
                                            height="200px" style="margin-top:15px;">
                                    @endif
                                    @error('image2')
                                        <div class="error-feedback">
                                ...
                                <div class="col-md-13">
                                    ...
                                    @if (!empty($akhlakdetail->image3))
                                        <img src="{{ asset('upload/image/' . $akhlakdetail->image3) }}" alt="image1"
                                            height="200px" style="margin-top:15px;">
                                    @endif
                                    @error('image3')
                                        <div class="error-feedback">
                                ...
                                <tbody>
                                    @foreach ($akhlak as $val)
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($val->image1))
                                                    <img src="{{ asset('upload/image/' . $val->image1) }}"
                                                        alt="image1" height="150px">
                                                @endif

                                            </td>
                                            <td>
                                                @if (!empty($val->image2))
                                                    <img src="{{ asset('upload/image/' . $val->image2) }}"
                                                        alt="image2" height="150px">
                                                @endif
                                            </td>
                                            <td>
                                                @if (!empty($val->image3))
                                                    <img src="{{ asset('upload/image/' . $val->image3) }}"
                                                        alt="image3" height="150px">
                                                @endif
                                            </td>
