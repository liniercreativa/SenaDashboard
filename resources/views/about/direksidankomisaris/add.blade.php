                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="position_eng"
                                                            name="position_eng" value="{{ old('position_eng') }}">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea id="editor2" name="description_eng">{{ old('description_eng') }}</textarea>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea id="editor4" name="experience_eng">{{ old('experience_eng') }} </textarea>
