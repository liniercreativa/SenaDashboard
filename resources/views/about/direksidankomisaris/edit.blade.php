                            ...
                            <form class="row g-3" method="POST"
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (!empty($direksidankomisaris->image))
                                        <img src="{{ asset('upload/image/' . $direksidankomisaris->image) }}"
                                            alt="image" width="200px" style="margin-top:15px;">
                                    @endif
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="ckeditor-classic" name="description"> {{ old('description', $direksidankomisaris->description) }} </textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor1" name="experience"> {{ old('experience', $direksidankomisaris->experience) }} </textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" id="type" name="type">
                                        <option value="direksi" @if ($direksidankomisaris->type == 'direksi') selected @endif>
                                            Direksi</option>
                                        <option value="komisaris" @if ($direksidankomisaris->type == 'komisaris') selected @endif>
                                            Komisaris</option>
                                    </select>
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea id="editor2" name="description_eng">{{ old('description_eng', $direksidankomisaris->description_eng) }}</textarea>
