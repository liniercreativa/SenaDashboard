                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-card">
                                        <table
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Mahdi Tarihoran</td>
                                                    <td>
                                                        Admin
                                                    </td>
                                                    <td><span class="badge badge-soft-success p-2">Aktif</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Kajen Saptono</td>
                                                    <td>
                                                    ...
                                                    <td><span class="badge badge-soft-danger p-2">Tidak Aktif</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Raina Padmasari</td>
                                                    <td>
                                                        Admin
                                                    </td>
                                                    <td><span class="badge badge-soft-success p-2">Aktif</span></td>
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Session Overview</h4>
                        </div><!-- end card header -->
