...
Route::prefix('home')->middleware('auth')->group(function () {
    Route::get('/slider_list', [App\Http\Controllers\HomeController::class, 'slider_list'])->name('home.slider_list');
    Route::get('/slider_add', [App\Http\Controllers\HomeController::class, 'slider_add'])->name('home.slider_add');
    Route::post('/slider_store', [App\Http\Controllers\HomeController::class, 'slider_store'])->name('home.slider_store');

    Route::get('/slider_edit/{id}', [App\Http\Controllers\HomeController::class, 'slider_edit'])->name('home.slider_edit');
    Route::put('/slider_update/{id}', [App\Http\Controllers\HomeController::class, 'slider_update'])->name('home.slider_update');

    Route::get('/slider_destroy/{id}', [App\Http\Controllers\HomeController::class, 'slider_destroy'])->name('home.slider_destroy');
